...
var (
    ...
    keywords       = flag.String("keywords", "star trek,Star Trek,Enterprise,Voyager,Deep Space Nine,DS9,ds9,Deep Space 9,deep space nine,deep space 9,the next generation,The Next Generation,next gen,Next Gen", "keywords to track")
